...
**
** Created: Sun Jun 10 03:27:06 2012
...
static const char qt_meta_stringdata_QsciAbstractAPIs[] = {
    "QsciAbstractAPIs\0"
};

const QMetaObject QsciAbstractAPIs::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QsciAbstractAPIs,
      qt_meta_data_QsciAbstractAPIs, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QsciAbstractAPIs::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciAbstractAPIs))
